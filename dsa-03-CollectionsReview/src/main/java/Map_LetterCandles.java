...
public class Map_LetterCandles {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Enter candle letter: ");
    ...
    public static int letterCandlesCost(int letterCount, int m, String str) {
        ...
        // create a hashMap
        //O(n<26)
        // character as Key value, Integer for frequency
